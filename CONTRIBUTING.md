...
runs in [`validate.yml`](.github/workflows/validate.yml):
...
Then run the packaging-manifest check ([`validate.yml`](.github/workflows/validate.yml)
...
- [README.md](README.md) — why this repo exists and its architecture.
